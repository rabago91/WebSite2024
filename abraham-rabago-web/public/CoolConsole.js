...
function cc_rainbow(text) {
    ...
    let args = Array();
    let color1 = DEFAULT_STYLE +" color: #F43445";
    let color2 = DEFAULT_STYLE +" color: #FF8A02";
    let color3 = DEFAULT_STYLE +" color: #FAD716";
    let color4 = DEFAULT_STYLE +" color: #01BA72";
    let color5 = DEFAULT_STYLE +" color: #01C2DE";
    let color6 = DEFAULT_STYLE +" color: #00418D";
    let color7 = DEFAULT_STYLE +" color: #602778";
