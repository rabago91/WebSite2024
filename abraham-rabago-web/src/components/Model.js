...
const donutAux = {
  ...
  url: "./Lights3D/EscenaIluminacion02.gltf",
};
//Scene & Camera
...
gltfLoader.load(
  ...
  (gltf) => {
    ...
    DonutLoaded.scale.multiplyScalar(.2);
    DonutLoaded.rotateZ(0);
    DonutLoaded.rotateY(0);
...
const spotlight1 = new THREE.SpotLight(0x0000ff, 10);
spotlight1.position.set(1.1,.8,-.8);
spotlight1.angle = Math.PI/4;
spotlight1.penumbra = .3;
scene.add(spotlight1);

const spotlight2 = new THREE.SpotLight(0xff0000, 10);
spotlight2.position.set(1,.8,.85);
...
pointlight3.position.set(1.1,.8,-.8);

const pointlight4 = new THREE.PointLight(0xff0000, 1);
scene.add(pointlight4);
pointlight4.position.set(1,.8,.85);

// const ball1 = new THREE.SphereGeometry(.1)
// const ball1Mat = new THREE.MeshBasicMaterial(0xffff00)
// var sphere1 = new THREE.Mesh(ball1, ball1Mat);
// sphere1.position.set(1,.8,.85)
// scene.add(sphere1);

// const ball2 = new THREE.SphereGeometry(.1)
// const ball2Mat = new THREE.MeshBasicMaterial(0xffff00)
// var sphere2 = new THREE.Mesh(ball2, ball2Mat);
// sphere2.position.set(1.1,.8,-.8)
// scene.add(sphere2);

// const ball3 = new THREE.SphereGeometry(.1)
// const ball3Mat = new THREE.MeshBasicMaterial(0xffff00)
// var sphere3 = new THREE.Mesh(ball3, ball3Mat);
